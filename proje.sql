...
-- Üretim Zamanı: 19 Kas 2025, 16:55:59
...
CREATE TABLE IF NOT EXISTS `basvurular` (
  `tc_kimlik` varchar(11) CHARACTER SET utf8mb4 COLLATE utf8mb4_turkish_ci NOT NULL,
  `ad_soyad` varchar(200) CHARACTER SET utf8mb4 COLLATE utf8mb4_turkish_ci DEFAULT NULL,
  `email` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_turkish_ci DEFAULT NULL,
  `egitim_durumu` enum('lisans','yuksek_lisans','diger') CHARACTER SET utf8mb4 COLLATE utf8mb4_turkish_ci DEFAULT NULL,
  `motivasyon_metni` text CHARACTER SET utf8mb4 COLLATE utf8mb4_turkish_ci,
  `ozgecmis_path` varchar(500) CHARACTER SET utf8mb4 COLLATE utf8mb4_turkish_ci DEFAULT NULL,
  `ogrenci_belgesi_path` varchar(500) CHARACTER SET utf8mb4 COLLATE utf8mb4_turkish_ci DEFAULT NULL,
  `ip_adresi` varchar(45) CHARACTER SET utf8mb4 COLLATE utf8mb4_turkish_ci DEFAULT NULL,
  `durum` enum('beklemede','incelendi','kabul','ret') CHARACTER SET utf8mb4 COLLATE utf8mb4_turkish_ci DEFAULT 'beklemede',
...
('10454258704', 'Büşra Şahin', 'cucucu@gmail.com', 'lisans', 'cokcokguzel', 'dosyalar/file.pdf', 'dosyalar/olucem.jpg', '::1', 'beklemede', '2025-11-19 16:16:00', '2025-11-19 16:16:00'),
('47584542512', 'deneme deneme', 'deneme@gmail.com', 'yuksek_lisans', 'blaa', 'dosyalar/file.pdf', 'dosyalar/akcn.jpg', '::1', 'beklemede', '2025-11-19 16:29:14', '2025-11-19 16:29:14'),
('45784562155', 'bubu', 'dene@gmail.com', 'lisans', 'bunusunu', 'dosyalar/file.pdf', 'dosyalar/olucem.jpg', '::1', 'beklemede', '2025-11-19 16:44:17', '2025-11-19 16:44:17');
...
CREATE TABLE IF NOT EXISTS `eski_basvurular` (
  ...
  `tc_kimlik` varchar(11) CHARACTER SET utf8mb4 COLLATE utf8mb4_turkish_ci DEFAULT NULL,
  `ad_soyad` varchar(200) CHARACTER SET utf8mb4 COLLATE utf8mb4_turkish_ci DEFAULT NULL,
  `email` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_turkish_ci DEFAULT NULL,
  `egitim_durumu` enum('lisans','yuksek_lisans','diger') CHARACTER SET utf8mb4 COLLATE utf8mb4_turkish_ci DEFAULT NULL,
  `motivasyon_metni` text CHARACTER SET utf8mb4 COLLATE utf8mb4_turkish_ci,
  ...
  `ogrenci_belgesi_path` varchar(500) CHARACTER SET utf8mb4 COLLATE utf8mb4_turkish_ci DEFAULT NULL,
  `ip_adresi` varchar(45) CHARACTER SET utf8mb4 COLLATE utf8mb4_turkish_ci DEFAULT NULL,
  `durum` enum('kabul','ret','iptal') CHARACTER SET utf8mb4 COLLATE utf8mb4_turkish_ci DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `projeler` (
  `id` int NOT NULL AUTO_INCREMENT,
  `basvuru_tc` varchar(11) CHARACTER SET utf8mb4 COLLATE utf8mb4_turkish_ci DEFAULT NULL,
  `proje_adi` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_turkish_ci DEFAULT NULL,
  `aciklama` text CHARACTER SET utf8mb4 COLLATE utf8mb4_turkish_ci,
  `link` varchar(500) CHARACTER SET utf8mb4 COLLATE utf8mb4_turkish_ci DEFAULT NULL,
  `created_at` timestamp NULL DEFAULT CURRENT_TIMESTAMP,
  PRIMARY KEY (`id`),
